//
// Created by siduk on 10.07.2023.
//

#ifndef VIDEOEDITOR_FFMPEGDECODE_H
#define VIDEOEDITOR_FFMPEGDECODE_H
...
namespace decoder{
    ...
    public:
        ...
        int decode_type = DecodeType::DO_TMP_JITTER;
    ...
    public:
        explicit VideoIOContext(const std::string& fname)
            ...
            if (inputFile_ == nullptr){
                BasicLogger().Log(ERROR, fname.c_str());
            }
...
#endif //VIDEOEDITOR_FFMPEGDECODE_H
